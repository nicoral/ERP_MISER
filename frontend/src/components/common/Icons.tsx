...
export const UnblockIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    className={className}
...
export const EmployeesIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    className={className}
...
export const WarehouseIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    className={className}
...
export const ServicesIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    className={className}
...
export const SuppliersIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    className={className}
...
export const ProcessIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    className={className}
...
export const DocumentIcon: React.FC<{ className?: string }> = ({
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M7 21h10a2 2 0 002-2V9.586a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z"
    />
  </svg>
);

export const CostCenterIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    className={className}
...
export const LogisticsIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    className={className}
...
export const RolesIcon: React.FC<{ className?: string }> = ({ className }) => (
  ...
  >
    ...
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M15 7a2 2 0 012 2v4a2 2 0 01-2 2H9a2 2 0 01-2-2V9a2 2 0 012-2h6z"
    />
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const PublishIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    className={className}
...
export const QuotationIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    className={className}
...
export const PriceTagIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    className={className}
...
export const ShoppingCartIcon: React.FC<{ className?: string }> = ({
  ...
  >
    ...
    <path
      d="M10.998,10l0.497,2h13.65l-1.909,7H11.781L9.159,8.515C8.937,7.625,8.137,7,7.219,7H5C4.448,7,4,7.448,4,8
...
export const ExitPartIcon: React.FC<{ className?: string }> = ({
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M20 12H4m8-8l-8 8 8 8"
    />
  </svg>
);

export const FuelControlIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    className={className}
