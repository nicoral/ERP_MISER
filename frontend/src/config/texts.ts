  ...
  suppliers: {
    ...
    form: {
      fields: {
        ...
        mobile: 'Teléfono',
        email: 'Correo electrónico',
        entity_bank_account_pen: 'Entidad bancaria PEN',
        bank_account_pen: 'Cuenta bancaria PEN',
        interbank_account_pen: 'Cuenta interbancaria PEN',
        entity_bank_account_usd: 'Entidad bancaria USD',
        bank_account_usd: 'Cuenta bancaria USD',
        interbank_account_usd: 'Cuenta interbancaria USD',
        return_policy: 'Política de devolución',
        applies_withholding: 'Aplica retención',
        rating: 'Calificación',
        status: 'Estado',
        categories: 'Líneas',
      },
